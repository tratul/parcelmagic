...
<main class="signup-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <h3 class="card-header text-center">Campaign Create</h3>
                    <div class="card-body">
                        <form action="{{ route('campaign.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" id="total_budget" class="form-control"
                                    name="total_budget" step="any" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" id="daily_budget" class="form-control"
                                    name="daily_budget" step="any" required>
                            ...
                            <div class="d-grid mx-auto">
                                <button type="submit" class="btn btn-dark btn-block">Create Campaign</button>
                            </div>
                        </form>
                    </div>
                </div>
